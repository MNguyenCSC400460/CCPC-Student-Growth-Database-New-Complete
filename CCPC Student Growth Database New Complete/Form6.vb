Public Class teacherDownloadReports
    ...
    Private Sub editTeacher_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles editTeacher.LinkClicked
        Me.Hide()
        teacherEditTeacher.Show()
    End Sub
